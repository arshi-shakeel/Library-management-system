...
if(isset($_SESSION['login_user']))
{
    $sql=" SELECT student.username,roll,books.bid,name,authors,edition,status FROM student 
...
else
{
    ?>
    <br>
        <h4 style="text-align:center;color:#9ACD32">You need to login to see the request.</h4>
